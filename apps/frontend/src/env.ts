...
export const env = {
  apiBaseUrl: normalizeApiBaseUrl(typeof window !== 'undefined' && !isLocalHost(window.location.hostname) ? defaultApiBaseUrl() : import.meta.env.VITE_API_BASE_URL || defaultApiBaseUrl()),
